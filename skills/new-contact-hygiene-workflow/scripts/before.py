...
# ///
"""
New Contact Hygiene Workflow — Before
...
PLANNED_NAMES = ["HYGIENE: Default Lifecycle Stage for New Contacts (API)"]

print("=" * 60)
print("BEFORE: New Contact Hygiene Workflow — workflow inventory")
print("=" * 60)
print()
